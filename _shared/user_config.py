...
DEFAULT_CONFIG = {
    ...
    "daily_papers": {
        ...
        "topic_clusters": {
            "A1_World_Model": {"label": "World Model", "keywords": []},
            "A2_Robot_Manipulation": {"label": "Robot Manipulation & Policy", "keywords": []},
            "A3_Embodied_Navigation": {"label": "Embodied Perception & Navigation", "keywords": []},
            "A4_Agentic_Design": {"label": "Agent Architecture & Design", "keywords": []},
            "B1_GPU_Training": {"label": "GPU Training", "keywords": []},
            "B2_GPU_Inference": {"label": "GPU Inference / Serving", "keywords": []},
            "C1_Diffusion_Gen": {"label": "Diffusion & Generative Models", "keywords": []},
        },
        "arxiv_categories": ["cs.RO", "cs.CV", "cs.AI", "cs.LG"],
        "min_score": 2,
        "top_n": 30,
        "ensure_clusters": ["B2_GPU_Inference", "A4_Agentic_Design"],
    },
    "automation": {
